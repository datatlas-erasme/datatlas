...
sed -i "s#REACT_APP_MATOMO_TRACKER_URL_DEFAULT_VALUE#$REACT_APP_MATOMO_TRACKER_URL#g" /usr/share/nginx/html/static/js/*.js
echo "Replacing DEFAULT_REACT_APP_MATOMO_SITE_ID_DEFAULT_VALUE with $REACT_APP_MATOMO_SITE_ID"
sed -i "s#DEFAULT_REACT_APP_MATOMO_SITE_ID_DEFAULT_VALUE#$REACT_APP_MATOMO_SITE_ID#g" /usr/share/nginx/html/static/js/*.js
